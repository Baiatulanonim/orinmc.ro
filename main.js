    ...
    groups: [
      {
        ...
        members: [
          ...
          { name: 'eusuntcris',  role: 'Fondator', icon: '🥇', description: 'Responsabil de jumătate din ideile bune și toate evenimentele haotice. Staff-ul îl adoră și îl teme în egală măsură.' },
        ],
      },
      {
        id: 'co-fondatori', title: 'Co-Fondatori', icon: '🥈',
        members: [
          { name: 'Johannis', role: 'Co-Fondator', icon: '🥈', description: 'Cel mai accesibil din staff. Nu știi cui să-i scrii? Scrie-i lui. O să răspundă.' },
          { name: 'Cretzu',   role: 'Co-Fondator', icon: '🥈', description: 'Nu tolerează cheat-eri. Nu tolerează drama. Cam atât. Dar e corect — și asta contează.' },
          { name: 'JonhyXD',  role: 'Co-Fondator', icon: '🥈', description: 'Dacă s-a organizat ceva mișto pe server, JonhyXD a avut de-a face cu asta. Garantat.' },
